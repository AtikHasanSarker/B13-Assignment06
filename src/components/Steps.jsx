      ...
      <div className="bg-gray-100 py-30">
        <div className="max-w-300 mx-auto px-5">
          <div className="text-center">
            <h3 className="text-4xl md:text-5xl font-extrabold">Get Started in 3 Steps</h3>
            <p className="my-4">
              Start using premium digital tools in minutes, not hours.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7.5 mt-10">
            <div className="bg-white relative flex flex-col gap-4 items-center px-6 py-22 border border-gray-200 rounded-2xl">
